...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen light:bg-gray-900 sm:items-center py-4 sm:pt-0" style="background-color: #fff;">
            @if (Route::has('login'))
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 row">
                <div class="col-6">
                    <div class="card-header"><h1>myGram</h1></div>
                    <div class="img"><img src="https://i.pinimg.com/564x/f7/81/f2/f781f25a0ef25adbe5f7348f3a26f373.jpg" alt="" class="img-fluid"></div>
                </div>
                <div class="col-6 d-flex flex-column justify-content-center">
                    <div class="d-flex flex-column justify-content-end">
                        <h1 class="text-right">IN <mark>CONNECTION</mark></h1>
                        <h1 class="text-right">WE TRUST</h1>
                    </div>
        ...
        <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
            ...
            <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                DobolGram v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})
            </div>
        </div>
    </body>
</html>
